...
# ADD ARTICULO TO A PEDIDO
INSERT INTO V1T_PEDIDO_ARTICULO (
	PedArtPed, PedArtArt,
    PedArtPreUni, PedArtCanSol, PedArtCanDes, PedArtEstReg
) VALUES (
	2, 4,
    120.25, 4, 4, "A"
);

# EDIT ARTICULO IN A PEDIDO
UPDATE V1T_PEDIDO_ARTICULO
SET PedArtPreUni=79.89,
PedArtCanSol=80, PedArtCanDes=95,
PedArtEstReg="I"
WHERE PedArtPed=2 AND PedArtArt=4;
